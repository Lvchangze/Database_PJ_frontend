...
<!--    查询护士长并显示其结果      -->
          ...
          <table class="table_head table_border" v-if="nurseLeaderResult.length !== 0">
            <tr>
              <th class="table_content" id="meetingName">工号</th>
              <th class="table_content" id="meetingTime">姓名</th>
              <th class="table_content" id="meetingStatus">性别</th>
              <th class="table_content" id="operate">年龄</th>
            </tr>
          </table>
          <table class="table_head" v-for="(item,index) in nurseLeaderResult" :key="index">
            <tr class="table_row">
